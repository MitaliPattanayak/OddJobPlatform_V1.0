...
namespace OddJobPlatformV1._0.Tests
{
    ...
    public class OddJobPlatformTest
    {
        ...
        public void Invalid_When_JobName_Is_Null()
        {
            ...
            obj.jobName = "";
            NUnit.Framework.Assert.AreEqual(obj.checkRequiredFields(obj), false);
        }
        ...
        public void Valid_When_Nofield_Is_NotNull()
        {
            ...
            NUnit.Framework.Assert.AreEqual(obj.checkRequiredFields(obj), true);
        }
        ...
        public void Check_ValidEmail()
        {
           ...
           NUnit.Framework.Assert.AreEqual(obj.emailIsValid(email), true);
        }
